...
public class DelgadosChoice 
{
	...
	public static void orderingMenu()
	{
		...
		+ tamalesOrdered + " tamales, " + tacoSaladOrdered + " containers of taco salad, " + chipsSalsaOrdered + " containers of chips & salsa, " + taquitosOrdered + " taquitos, " 
		+ chimichangaOrdered + " chimichangas " + potatoOleOrdered + " potato oles,");
