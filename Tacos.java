...
public class Tacos {
	...
	public static void orderingMenu()
	{
		...
		System.out.println("You ordered " + tacoOrdered + " tacos, " + burritoOrdered + " burritos, " + popOrdered + " Mt. Dews, " + churrosOrdered + " churros, \n" + tamalesOrdered + " tamales, " 
	...
	public static void menu()
	{
		...
		System.out.println("  ~        Mt. Dew | price | $0.99      ~  ");
		System.out.println("  |        Churros | price | $2.00      |  ");
		System.out.println("  ~        Tamales | price | $1.50      ~  ");
		System.out.println("  |     Taco Salad | price | $2.50      |  ");
		System.out.println("  ~  Chips & Salsa | price | $1.00      ~  ");
		System.out.println("  |       Taquitos | price | $1.50      |  ");
		System.out.println("  ~    Chimichanga | price | $2.00      ~  ");
		System.out.println("  |     Potato Ole | price | $1.50      |  ");
		System.out.println("  ~                                     ~  ");
		System.out.println("  |                                     |  ");
		System.out.println("  ~                                     ~  ");
		System.out.println("  |                                     |  ");
